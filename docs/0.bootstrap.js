...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* WEBPACK VAR INJECTION */(function(module) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"Population\", function() { return Population; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"RGB\", function() { return RGB; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"__wbindgen_throw\", function() { return __wbindgen_throw; });\n/* harmony import */ var _cppn_interactive_bg_wasm__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./cppn_interactive_bg.wasm */ \"../pkg/cppn_interactive_bg.wasm\");\n\n\nconst lTextDecoder = typeof TextDecoder === 'undefined' ? (0, module.require)('util').TextDecoder : TextDecoder;\n\nlet cachedTextDecoder = new lTextDecoder('utf-8', { ignoreBOM: true, fatal: true });\n\ncachedTextDecoder.decode();\n\nlet cachegetUint8Memory0 = null;\nfunction getUint8Memory0() {\n    if (cachegetUint8Memory0 === null || cachegetUint8Memory0.buffer !== _cppn_interactive_bg_wasm__WEBPACK_IMPORTED_MODULE_0__[\"memory\"].buffer) {\n        cachegetUint8Memory0 = new Uint8Array(_cppn_interactive_bg_wasm__WEBPACK_IMPORTED_MODULE_0__[\"memory\"].buffer);\n    }\n    return cachegetUint8Memory0;\n}\n\nfunction getStringFromWasm0(ptr, len) {\n    return cachedTextDecoder.decode(getUint8Memory0().subarray(ptr, ptr + len));\n}\n/**\n*/\nclass Population {\n\n    static __wrap(ptr) {\n        const obj = Object.create(Population.prototype);\n        obj.ptr = ptr;\n\n        return obj;\n    }\n\n    __destroy_into_raw() {\n        const ptr = this.ptr;\n        this.ptr = 0;\n\n        return ptr;\n    }\n\n    free() {\n        const ptr = this.__destroy_into_raw();\n        _cppn_interactive_bg_wasm__WEBPACK_IMPORTED_MODULE_0__[\"__wbg_population_free\"](ptr);\n    }\n    /**\n    * @param {number} size\n    * @returns {Population}\n    */\n    static new(size) {\n        var ret = _cppn_interactive_bg_wasm__WEBPACK_IMPORTED_MODULE_0__[\"population_new\"](size);\n        return Population.__wrap(ret);\n    }\n    /**\n    * @param {number} index_parent_0\n    * @param {number} index_parent_1\n    */\n    next_generation(index_parent_0, index_parent_1) {\n        _cppn_interactive_bg_wasm__WEBPACK_IMPORTED_MODULE_0__[\"population_next_generation\"](this.ptr, index_parent_0, index_parent_1);\n    }\n    /**\n    * @param {number} individual_index\n    * @param {number} input_x\n    * @param {number} input_y\n    * @returns {RGB}\n    */\n    probe_individual(individual_index, input_x, input_y) {\n        var ret = _cppn_interactive_bg_wasm__WEBPACK_IMPORTED_MODULE_0__[\"population_probe_individual\"](this.ptr, individual_index, input_x, input_y);\n        return RGB.__wrap(ret);\n    }\n    /**\n    * @param {number} individual_index\n    * @param {number} dimension_x\n    * @param {number} dimension_y\n    * @param {number} resolution\n    * @returns {number}\n    */\n    probe_individual_complete(individual_index, dimension_x, dimension_y, resolution) {\n        var ret = _cppn_interactive_bg_wasm__WEBPACK_IMPORTED_MODULE_0__[\"population_probe_individual_complete\"](this.ptr, individual_index, dimension_x, dimension_y, resolution);\n        return ret;\n    }\n}\n/**\n*/\nclass RGB {\n\n    static __wrap(ptr) {\n        const obj = Object.create(RGB.prototype);\n        obj.ptr = ptr;\n\n        return obj;\n    }\n\n    __destroy_into_raw() {\n        const ptr = this.ptr;\n        this.ptr = 0;\n\n        return ptr;\n    }\n\n    free() {\n        const ptr = this.__destroy_into_raw();\n        _cppn_interactive_bg_wasm__WEBPACK_IMPORTED_MODULE_0__[\"__wbg_rgb_free\"](ptr);\n    }\n    /**\n    * @returns {number}\n    */\n    red() {\n        var ret = _cppn_interactive_bg_wasm__WEBPACK_IMPORTED_MODULE_0__[\"rgb_red\"](this.ptr);\n        return ret >>> 0;\n    }\n    /**\n    * @returns {number}\n    */\n    green() {\n        var ret = _cppn_interactive_bg_wasm__WEBPACK_IMPORTED_MODULE_0__[\"rgb_green\"](this.ptr);\n        return ret >>> 0;\n    }\n    /**\n    * @returns {number}\n    */\n    blue() {\n        var ret = _cppn_interactive_bg_wasm__WEBPACK_IMPORTED_MODULE_0__[\"rgb_blue\"](this.ptr);\n        return ret >>> 0;\n    }\n}\n\nfunction __wbindgen_throw(arg0, arg1) {\n    throw new Error(getStringFromWasm0(arg0, arg1));\n};\n\n\n/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./../www/node_modules/webpack/buildin/harmony-module.js */ \"./node_modules/webpack/buildin/harmony-module.js\")(module)))\n\n//# sourceURL=webpack:///../pkg/cppn_interactive_bg.js?");
...
/*!***************************************!*\
  !*** ../pkg/cppn_interactive_bg.wasm ***!
  \***************************************/
/*! exports provided: memory, __wbg_rgb_free, rgb_red, rgb_green, rgb_blue, __wbg_population_free, population_new, population_next_generation, population_probe_individual, population_probe_individual_complete */
